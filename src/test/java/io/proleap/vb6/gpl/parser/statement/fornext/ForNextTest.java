package io.proleap.vb6.gpl.parser.statement.fornext;
...
public class ForNextTest extends VbTestSupport {
	...
	public void test() throws Exception {
		final File inputFile = new File("src/test/resources/io/proleap/vb6/gpl/parser/statement/fornext/ForNext.cls");
