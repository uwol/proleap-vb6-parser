package io.proleap.vb6.gpl.parser.statement.function;
...
public class FunctionTest extends VbTestSupport {
	...
	public void test() throws Exception {
		final File inputFile = new File("src/test/resources/io/proleap/vb6/gpl/parser/statement/function/Function.cls");
