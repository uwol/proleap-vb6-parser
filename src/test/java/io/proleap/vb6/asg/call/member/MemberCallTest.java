...
public class MemberCallTest extends VbTestBase {
	...
	public void test() throws Exception {
		...
		{
			final StandardModule myModule = program.getStandardModule("MyModule");
			assertNotNull(myModule);

			{
				final io.proleap.vb6.asg.metamodel.Type myType = myModule.getType("MyType");
...

				{
					...
					assertEquals(2, myFunction.getTypeElementCalls().size());
				}
