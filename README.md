...
* The test suite executes tests against MSDN statement examples and GPLed VB6 test files. Unit tests and parse tree files were generated by class org.vb6.TestGenerator from those VB6 test files.
...
-------------------------------------------------------
 T E S T S
-------------------------------------------------------
Running org.vb6.gpl.calls.CallsTest
...
Running org.vb6.gpl.calls.Module1Test
...
Results :
